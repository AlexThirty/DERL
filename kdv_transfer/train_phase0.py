...
# Generate the times
t = 0.35*torch.distributions.Uniform(0.,1.).sample((batch_size*train_steps,1))
# Generate the point
...
eval_dataloader = DataLoader(eval_dataset, batch_size, generator=gen, shuffle=True)
...
plot_errors([model], ['Phase 0'], 'plots_phase0', kdv_data, model, compare=False)
