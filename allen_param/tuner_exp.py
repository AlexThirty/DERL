...
def train_model(config):
    ...
    train_dataset = torch.load(f'{abs_path}/train_data/train_data_rand.pt')
    true_dataset = torch.load(f'{abs_path}/val_data/val_data_rand.pt')
    boundary_dataset = torch.load(f'{abs_path}/boundary_dataset.pt')
